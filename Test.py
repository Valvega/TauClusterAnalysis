...
tfile_data2  = TFile.Open("%s/histos_dtmodel_0M_Data.root"%(input_dir))
tfile_data3  = TFile.Open("%s/histos_dtmodel_0L_Data.root"%(input_dir))
tfile_data4  = TFile.Open("%s/histos_dtmodel_0VL_Data.root"%(input_dir))
tfile_data5  = TFile.Open("%s/histos_dtmodel_0VVL_Data.root"%(input_dir))
tfile_data6  = TFile.Open("%s/histos_dtmodel_0VVVL_Data.root"%(input_dir))
##Out of time
h1           =  tfile_data1.Get("h_model_clustersize_oot")
h2           =  tfile_data2.Get("h_model_clustersize_oot")
h3           =  tfile_data3.Get("h_model_clustersize_oot")
h4           =  tfile_data4.Get("h_model_clustersize_oot")
h5           =  tfile_data5.Get("h_model_clustersize_oot")
h6           =  tfile_data6.Get("h_model_clustersize_oot")		
#In time
h7           =  tfile_data1.Get("h_model_clustersize")
h8           =  tfile_data2.Get("h_model_clustersize")
h9           =  tfile_data3.Get("h_model_clustersize")
h10          =  tfile_data4.Get("h_model_clustersize")
h11          =  tfile_data5.Get("h_model_clustersize")
h12          =  tfile_data6.Get("h_model_clustersize")
...
histoframe.GetXaxis().SetTitle("Number of DT RecHits")
...
leg_1.AddEntry(h7,"Out of Time, Data (Tau region)", "f")
#leg_1.AddEntry(h5,"In Time, Data (0VVLID region)", "pe")
#leg_1.AddEntry(h11,"Out of Time, Data (0VVLID region)", "f")
#leg_1.AddEntry(h6,"In Time, Data (0VVVLID region)", "pe")
#leg_1.AddEntry(h12,"Out of Time, Data (0VVVLID region)", "f")
...
#Save plot
c1.Update()
c1.SaveAs("%s/dt_nrechits_Tau.pdf"%(output_dir))
#c1.SaveAs("%s/dt_nrechits_0VVL.pdf"%(output_dir))
#c1.SaveAs("%s/dt_nrechits_0VVVL.pdf"%(output_dir))
